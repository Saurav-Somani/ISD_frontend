...
export default function OrderHistoryAdmin() {
  ...
  function searchByDate() {
    ...
    axios.get(`http://localhost:8080/admin/searchByOrderDate/${x}`)
    ...
    <div className="main-body">
      ...
      <div className="content-box">
        <div style={{ display: 'flex', width: "100%", justifyContent: "center", marginBottom: "2rem" }}>
          <div>
            <input className="searchInput" placeholder="Enter Order Date" id="date" />
          </div>
          <div className="ml-2">
            <button type="submit" className="btn btn-primary searchButton" onClick={searchByDate}>
